...
const findFriend = (user, callback) => {
    ...
    pool.getConnection(function (err, conn) {
        ...
        let exec = conn.query('((select user_index as friend_index  from friend where friend_index = ?) union\n' +
            '(select friend_index from friend where user_index = ?)) order by friend_index asc', [user, user] , function (err, result) {
            conn.release()
